...
namespace ExoScan
{
    public partial class ColorIndexing
    {
        ...
        const string PrimaryColorX = "PrimaryColor";
        const string DifferentialColorX = "DifferentialColor";
        ...
        public string PrimaryColorConfiguration
        {
            get { return GetConfig(PrimaryColorX); }
            set { SetConfig(PrimaryColorX, value); }
        }

        public string DifferentialColorConfiguration
        {
            get { return GetConfig(DifferentialColorX); }
            set { SetConfig(DifferentialColorX, value); }
        }
        ...
        public static ColorIndexing.ColorDataSource ColorXNameToColorDataSourceEnum(string colorXName)
        {
        ...
        public static ColorIndexing.StandardColors FilterXNameToStandardsEnum(string filterXName)
        {
            //Translates a string color name from JSAssign to the ColorDataSource enumeration
            switch (filterXName)
            {
                ...
                case GpX: { return ColorIndexing.StandardColors.Gp; }
                case GBpX: { return ColorIndexing.StandardColors.GBp; }
                case GRpX: { return ColorIndexing.StandardColors.GRp; }
                default: return ColorIndexing.StandardColors.Gp;
            }
        }

        public static ColorIndexing.StandardColors FilterStandardNameToStandardColorEnum(string stdFilterName)
        {
            switch (stdFilterName)
            {
                ...
                case "Gp": { return StandardColors.Gp; }
        ...
        public static double GaiaToJohnson(StandardColors jcFilter, double gGp, double gGbp, double gGrp)
        {
