...
namespace ExoScan
{
    public static class Launcher
    {
        ...
        {
            //If StageSystemOn is set, then RunStageSystem gets the StageSystem filepath from the config file, if any
            //  then launches it and waits for completion.
        ...
        {
            //If ShutDownOn is set, then RunShutDown gets the postscan filepath from the ShutDown config file, if any
            //  then launches it and waits for completion.
