...
namespace ExoScan
{
    public partial class StarField
    {
        ...
        public StarField(ccdsoftImage tsx_Image, SampleManager.SessionSample sample)
        {
            ...
            if (TSX_Image != null)
                ExoScanFileManager.CloseImageFile(TSX_Image);
            bool FitsIsOpen = ExoScanFileManager.DirectOpenFitsFilePath(TSX_Image, sample.ImagePath);
        }
        ...
        public StarField(ccdsoftImage tsx_Image, string fitsFilePath)
        {
            ...
            if (TSX_Image != null)
                ExoScanFileManager.CloseImageFile(TSX_Image);
            bool FitsIsOpen = ExoScanFileManager.DirectOpenFitsFilePath(TSX_Image, fitsFilePath);
        }
        ...
        public void Close()
        {
            if (TSX_Image != null) ExoScanFileManager.CloseImageFile(TSX_Image);
        }
