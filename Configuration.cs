...
namespace ExoScan
{
    ...
    {
        public const string TargetListFilename = "ExoScanList.xml";
        public const string ColorListFilename = "ColorList.xml";

        //Private data
        const string ScanFolderName = "ExoScan";
        ...
        const string AutoRunOnExoTransitsX = "AutoRunOnExoTransits";
        const string PreTransitRunUpX = "PreTransitRunUp";
        const string PostTransitRunOutX = "PostTransitRunOut";

        const string DomeHomeAzX = "DomeHomeAz";

        string ssdir;  //ExoScan Root directory
        //string cmdir;  //Current Collection directory

        public Configuration()
        {
            //Check to see if ExoScan directory exists, if not, create the ExoScan folder path for the base folder.
            ...
            //The configuration file is set at in the ExoScan directory, if not there than create it with defaults.
            if (!File.Exists(ssdir + "\\" + ScanConfigurationFilename))
            {
                ...
                XElement cDefaultX = new XElement(ScanConfigurationRootX,
                    ...
                    new XElement(AutoRunOnExoTransitsX, "False"),
                    new XElement(PreTransitRunUpX, "60"),
                    new XElement(PostTransitRunOutX, "30"),
        ...
        public string ExoScanFolderPath
        {
        ...
        public string AutoRunOnExoTransits
        {
            get { return GetConfig(AutoRunOnExoTransitsX, "False"); }
            set { SetConfig(AutoRunOnExoTransitsX, value); }
        }

        public string PreTransitRunUp
        {
            get { return GetConfig(PreTransitRunUpX, "0"); }
            set { SetConfig(PreTransitRunUpX, value); }
        }

        public string PostTransitRunOut
        {
            get { return GetConfig(PostTransitRunOutX, "0"); }
            set { SetConfig(PostTransitRunOutX, value); }
        }
