...
namespace ExoScan
{
    public class SampleManager
    {
        ...
        public SampleManager(string targetName)
        {
            ...
            string targetDirectoryPath = cfg.ImageBankFolder;
            SampleImages = new List<SessionSample>();
        ...
        public SampleManager(DateTime targetDate)
        {
            ...
            List<string> targetDirectories = ExoScanFileManager.GetTargetPathList(targetDate);
            //Open each of the fits files in target directory
        ...
        public SampleManager(string targetName, DateTime targetDate, int sessionSet)
        {
            ...
            List<string> targetDirectories = ExoScanFileManager.GetTargetSessionPaths(targetName, targetDate, sessionSet);
            //Open each of the fits files in target directory
            if (targetDirectories != null)
