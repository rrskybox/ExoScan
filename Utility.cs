...
namespace ExoScan
{
    ...
    public static class Utility
    {
        ...
        public static DateTime GetImageSessionDate(DateTime sampleDT)
        {
            ...
            return ((sampleDT - TimeSpan.FromHours(12)).Date + TimeSpan.FromDays(1)).Date;
        }

        public static DateTime GetImageSessionDate(DateTime sampleDT, TimeSpan dayHours)
        {
            //Figure out the session date for this sample and add the given number of hours
            return (sampleDT - TimeSpan.FromHours(12)).Date + TimeSpan.FromDays(1) + dayHours;
        }

        private static DateTime TheLaterDate(DateTime date1, DateTime date2)
        {
        ...
        private static DateTime TheEarlierDate(DateTime date1, DateTime date2)
        {
            //returns the most recent date
            if (date1 > date2)
                return date2;
