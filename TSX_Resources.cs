...
namespace ExoScan
{
    internal class TSX_Resources
    {

        private static string QueryDestinationSubPath = "Software Bisque\\TheSky Professional Edition 64\\Database Queries\\ExoScanStandardFields.dbq";
        ...
        public static void InstallDBQs()
        {
            ...
            Stream dgstream = dgassembly.GetManifestResourceStream("ExoScan.ExoScanStandardFields.dbq");
            ...
            Stream dcstream = dcassembly.GetManifestResourceStream("ExoScan.StandardFields.SDBX");
        ...
        public static string GetTSXDirectoryPath()
        {
            ...
            string tsxDir = "TheSky Professional Edition 64";
        ...
        public static (DateTime? dusk, DateTime? dawn) GetTwilight()
        {
            ...
            //  Returns null as dusk or dawn if not available
            DateTime? dusk = null;
            DateTime? dawn = null;
            ...
            tsxo.Property(Sk6ObjectInformationProperty.sk6ObjInfoProp_DATE);
            DateTime date = Convert.ToDateTime(tsxo.ObjInfoPropOut);

            tsxo.Property(Sk6ObjectInformationProperty.sk6ObjInfoProp_TWIL_ASTRON_START);
            dawn = date + TimeSpan.FromHours(tsxo.ObjInfoPropOut) + TimeSpan.FromDays(1);
